    ...
    <section className="relative container md:mt-14 mx-auto w-full ">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-4 md:p-0">
        {[1, 2, 3, 4, 5, 6].map((item) => (
          <div
            key={item}
            className="bg-white rounded-2xl shadow-lg p-0 text-black border border-orange-500"
          >
            {/* Top header Product */}
            <div className="bg-orange-500 rounded-t-2xl px-4 py-5 flex items-center justify-center">
              <span className="text-white text-2xl font-bold text-center">1 Tahun, 25 Mbps</span>
            </div>
            <div className="p-6">
