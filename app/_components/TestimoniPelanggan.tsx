...
const TestimoniPelanggan = () => {
	...
	return (
		<section className="py-16 overflow-hidden bg-orange-500">
			<div className="container mx-auto px-4 text-center">
				...
				<style jsx global>{`
					...
					.animate-gradient-x {
						animation: gradient-x 4s ease-in-out infinite alternate;
					}
				`}</style>
