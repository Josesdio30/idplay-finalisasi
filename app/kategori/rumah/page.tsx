...
//               value={selectedRegion}
//               onChange={handleRegionChange}
//               disabled={isLoadingRegions} // Nonaktifkan dropdown saat loading
//               className="w-full max-w-xs p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500"
//             >
//               {isLoadingRegions ? (
...
//         {/* Hanya render ProductFacts jika sudah ada region yang terpilih */}
//         {selectedRegion && (
//             <ProductFacts customerType="Retail" region={selectedRegion} />
//         )}
//       </div>
