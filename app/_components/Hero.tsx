...
import { Info, MapPin, Network, Wifi } from 'lucide-react';
    ...
    <>
      ...
      <section className="relative container mx-auto lg:pt-14">
        ...
        <div className="absolute top-full left-2 lg:left-5 lg:right-auto right-2 flex items-center gap-1 z-20">
          <button
            className="bg-orange-500 text-white pl-4 pr-12 py-1.5 rounded-b-lg flex items-center gap-2"
            style={{
          ...
          <button
            className="bg-green-600 text-white pl-4 pr-12 py-1.5 rounded-b-lg ml-auto flex items-center gap-2"
            style={{
              clipPath: 'polygon(0 0, 100% 0%, 94% 100%, 0% 100%)'
            }}
          >
