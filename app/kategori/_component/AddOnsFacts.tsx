          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-700 text-base mb-2">
                Nikmati jangkauan Wi-Fi menyeluruh di seluruh rumah tanpa area
                sinyal lemah senilai hingga{' '}
              ...
              <button className="w-full bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 rounded-lg flex items-center justify-center space-x-2 transition-colors">
                <svg
